...
public interface AuditMessage {
	...
	String TABLE_STATE_FAILED_MESSAGE_AT_GETMETADATA = "this table may not exist at the source ... \n please check following things for more details :- \n";
	
	String TABLE_STATE_FAILED_MESSAGE_AT_CREATION = "this table exists at the source, but creation failed ... \n please check following things for more details :- \n";
